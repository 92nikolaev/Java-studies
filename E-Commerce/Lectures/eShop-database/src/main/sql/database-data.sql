...
insert into eshop_database.user_data (id, user_id, created_date, status, password, first_name, second_name, email, mobile_phone)
values (1, 1, now(), 'ACTIVE', 'password', 'ADMIN', 'ADMIN', 'admin@admin.ru', '911') ;
insert into eshop_database.user_data (id, user_id, created_date, status, password, first_name, second_name, email, mobile_phone)
values (2, 3, now(), 'ACTIVE', 'password123', 'USER', 'USER', 'admin@admin.ru', '911') ;
insert into eshop_database.user_data (id, user_id, created_date, status, password, first_name, second_name, email, mobile_phone)
values (3, 3, now(), 'UPDATED', 'new_password', 'USER', 'USER', 'admin@admin.ru', '911') ;
